...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    NSString *username = @"nevyn";
    NSString *password = @"1nth11nd";
	...
	// Favorite methods:
	NSLog(@"getFavoriteUpdatesFor: connectionIdentifier = %@", [twitterEngine getFavoriteUpdatesFor:username startingAtPage:0]);
